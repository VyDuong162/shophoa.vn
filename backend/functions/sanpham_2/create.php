...
<body>
    ...
    <div class="container-fluid">
        ...
        if (isset($_POST['btnSave'])) {
            ...
            // Câu l?nh INSERT
            $sql = "INSERT INTO `sanpham` (sp_ten, sp_gia, sp_giacu,sp_yeuthich sp_mota_ngan, sp_mota_chitiet, sp_ngaycapnhat, lh_id, mh_id, cd_id,km_id) VALUES ('$ten', $gia, $giacu,'$sp_yeuthich' '$motangan', '$motachitiet', '$ngaycapnhat', $lh_id, $mh_id,$cd_id, $km_id);";
            // Th?c thi INSERT
